...
const ACTION_LABELS: Record<string, string> = {
  ...
  reordered_issues: 'reordered issues',
  reordered_questions: 'reordered questions',
  reordered_ideas: 'reordered ideas',
  reordered_links: 'reordered links',
  reordered_metrics: 'reordered metrics',
  reordered_notes: 'reordered notes',
